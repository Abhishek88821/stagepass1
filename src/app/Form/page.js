                ...
                <div className="row" >
                    <div className="col-xl-12 col-lg-12 col-md-12 col-12" >
                        ...
                        <div className="form-box" >
                            <form className="form-div-box row p-0" method="" onSubmit={formSubmission()} >
                                <div className='col-lg-6 col-md-6 col-sm-6 col-12' >
                                    <div className='frm-div-lbl' >
                                        <label>Full Name<span>*</span></label>
                                        <div className="frm-div-inp d-flex position-relative" >
                                            <LuUser2 className="frm-icn" />
                                            <input type="text" className='form-control' placeholder='Type your good name' required="" name="fullName" onChange={handleChange} />
                                ...
                                <div className='col-lg-6 col-md-6 col-sm-6 col-12' >
                                    <div className='frm-div-lbl' >
                                        ...
                                        <div className="frm-div-inp d-flex position-relative" >
                                            ...
                                            <input type="text" className='form-control' placeholder='0000000000' name="phoneNumber" onChange={handleChange} maxLength={10} required="" />
                                            <LuCheck className="suc-sgn" />
                                        </div>
                                    </div>
                                </div>
                                <div className='col-lg-6 col-md-6 col-sm-6 col-12' >
                                    <div className='frm-div-lbl' >
                                        ...
                                        <div className="frm-div-inp d-flex position-relative" >
                                            ...
                                            <input type="text" className='form-control' placeholder='example@email.com' name="emailAddress" onChange={handleChange} required="" />
                                            <LuCheck className="suc-sgn" />
                                        </div>
                                    </div>
                                </div>
                                <div className='col-lg-6 col-md-6 col-sm-6 col-12' >
                                    <div className='frm-div-lbl' >
                                        ...
                                        <div className="frm-div-inp d-flex position-relative" >
                                            ...
                                            <input type="text" className='form-control' placeholder='Type your city' required="" name="city" onChange={handleChange} />
                                ...
                                <div className='col-lg-6 col-md-6 col-sm-6 col-12' >
                                    <div className='frm-div-lbl' >
                                        ...
                                        <div className="frm-div-inp d-flex position-relative" >
                                            ...
                                            <input type="text" className='form-control' placeholder='Choose event type' onChange={handleChange} name="typeofEvent" required="" />
